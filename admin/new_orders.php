                ...
                <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                    ...
                    <tbody>
                        <?php  
                           ...
                           $sql= "SELECT * FROM wb_order_table WHERE `status`='New' group by order_id";
                           $run = mysqli_query($con, $sql);
                               ...
                               foreach ($datas as  $value) 
                               {
                                  ...
                                  <tr>
                                    ...
                                    <td><?php 
                                        ...
                                        if ($type == 'ONLINE') {
                                          ?><h4 class="m-auto"><span class="badge badge-success-lighten"><i class="mdi mdi-coin"></i> Paid</span></h4><?php
                                        }else{
                                           ?><h4 class="m-auto"><span class="badge badge-info-lighten"><i class="mdi mdi-cash"></i> Unpaid</span></h4><?php 
                                        }
                                        ?>  
                                     </td>
                                    ...
                                    <td class="table-action">
                                        <a href="view_order.php?orderid=<?php echo $value['order_id'] ?>" class="btn btn-sm btn-success mx-0">View </a>
                                    </td>
