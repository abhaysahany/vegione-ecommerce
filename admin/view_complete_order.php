...
<head>
<meta charset="utf-8" />
<title>Order Details | Estore</title>
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="completed_orders.php">Completed Orders</a></li>
                            <li class="breadcrumb-item active">View Completed Orders</li>
                        </ol>
                    </div>
                ...
                <div class="horizontal-steps mt-4 mb-4 pb-5" id="tooltip-container">
                    <div class="horizontal-steps-content">
                        <div class="step-item ">
                            ...
                            <span class="mt-3"><?= date('d M, Y', strtotime($data_v['order_date'])) ?></span>
                        </div>
                        <div class="step-item">
                            <span>Packed</span>
                            <span class="mt-3"><?= date('d M, Y', strtotime($data_v['accept_reject_on'])) ?></span>
                        </div>
                        <div class="step-item">
                            <span>Shipped</span>
                            <span class="mt-3"><?= date('d M, Y', strtotime($data_v['shipped_on'])) ?></span>
                        </div>
                        <div class="step-item current">
                            <span>Delivered</span>
                            <span class="mt-3"><?= date('d M, Y', strtotime($data_v['delivered_on'])) ?></span>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li>
                                <p class="mb-2"><span class="fw-bold me-2">Shipped On:</span> <?=date('d M, Y',strtotime($odata['shipped_on'])) ?></p>
                                <p class="mb-2"><span class="fw-bold me-2">Tracking Id:</span> <?=$odata['tracking_id']?></p>
                                <p class="mb-2"><span class="fw-bold me-2">Courier:</span> <?=$odata['shipping_courier']?></p>
                                <p class="mb-0"><span class="fw-bold me-2">Delivered On:</span> <?=date('d M, Y',strtotime($odata['delivered_on'])) ?></p>
                            </li>
                        </ul>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="header-title mb-3">Order Payment</h4>

                        <div class="text-center">
                            <a href="javascript:;" class="btn btn-success mt-4 mb-4"><?=$odata['order_type']?> Payment</a>
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->
