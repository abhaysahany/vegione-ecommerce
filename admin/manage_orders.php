        ...
        <div class="card">
            <div class="card-header p-0 m-0">
                <div class="row justify-content-between m-0">
                    <div class="col-6 p-3"><h4 class="text-muted">Authorised Order Management</h4></div>
            ...
            <div class="card-body">
                ...
                <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                    ...
                    <?php  
                       ...
                       $sql= "SELECT * FROM wb_order_table WHERE `status`='Accepted' group by order_id";
                       $run = mysqli_query($con, $sql);
                       ...
                       if ($row > 0) 
                       {
                           ...
                           foreach ($datas as  $value) 
                           {
                              ...
                              <tr>
                                ...
                                <td><a href="download_invoice.php?orderid=<?php echo $value['order_id'] ?>">#Invoice</a> </td>
                                <td class="table-action">
                                    <a href="ship_orders.php?ship=<?php echo $value['order_id'] ?>" class="btn btn-sm btn-success mx-0">Ship Order </a>
                                </td>
                               </tr>
                               <?php
                           }
