...
<head>
<meta charset="utf-8" />
<title>Order Shipping | Estore </title>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body text-center">
                        <h4 class="header-title mb-3">Shipping Details</h4>
                        <form action="ship_orders.php" method="post">
                            <div class="form-group">
                               <label></label>
                               <input type="date" name="date" class="form-control" placeholder="Enter Shipping Date" required> 
                            </div>
                            <div class="form-group">
                               <label></label>
                               <input type="text" name="trackid" class="form-control" placeholder="Enter Tracking Id" required> 
                            </div>
                            <div class="form-group mb-3">
                               <label></label>
                               <input type="text" name="courier" class="form-control" placeholder="Enter Shipping Courier" required> 
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="orderid" value="<?=$orderid?>">
                               <button class="btn btn-success" name="ship">Ship Order Now</button> 
                            </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST['ship'])) {
   ...
   $sql="UPDATE `wb_order_table` SET `status`='Shipped',`shipped_on`='$date',`tracking_id`='$trackid',`shipping_courier`='$courier' WHERE `order_id`='$orderid'";
   $run = mysqli_query($con, $sql);
   ...
   if ($run) {
        ...
        ?>
         <script type="text/javascript">
             swal('Added!','Shipping Details have been added Successfully !','success')
                 .then(function(){
