...
<head>
    ...
    <title>Shipped Orders | Estore </title>
        ...
        <div class="card">
            <div class="card-header p-0 m-0">
                <div class="row justify-content-between m-0">
                    <div class="col-6 p-3"><h4 class="text-muted">Shipped Order Management</h4></div>
            ...
            <div class="card-body">
                ...
                <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                    ...
                    <?php  
                       ...
                       $sql= "SELECT * FROM wb_order_table WHERE `status`='Shipped' group by order_id";
                       $run = mysqli_query($con, $sql);
                       ...
                       if ($row > 0) 
                       {
                           ...
                           foreach ($datas as  $value) 
                           {
                              ...
                              <tr>
                                <td><?php echo $i ?></td>
                                <td><?php echo date('d/m/Y', strtotime($value['shipped_on']))   ?></td>
                                ...
                                <td><?php echo $value['shipping_courier'] ?> </td>
                                <td class="table-action">
                                    <a href="order_status.php?deliver=<?php echo $value['order_id'] ?>" class="btn btn-sm btn-success mx-0">Deliver Order </a>
                                </td>
                               </tr>
                               <?php
                           }
